#
#  Be sure to run `pod spec lint BFPay.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "陈玉琪"
  # s.authors            = { "陈玉琪" => "yq.chen@renrunkeji.com" }
  # s.social_media_url   = "http://twitter.com/陈玉琪"
